//! demo-graphql — Phase 48 static-crate entry point.
//!
...
pub fn service() -> Box<dyn Service> {
    Box::new(DemoGraphqlService)
}

struct DemoGraphqlService;

impl Service for DemoGraphqlService {
    ...
    fn schemas(&self) -> Vec<&'static str> {
        vec![include_str!("../schemas/graph.graphql")]
    }
